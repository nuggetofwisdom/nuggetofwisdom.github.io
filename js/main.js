...
jQuery(document).ready(function($) 
{
    ...
    var pwdv = ["jacob"]  // To print pwd 
    var s = [];   //Array for directories
    var f = [];   //Array for files
    var count = 6;    //Required to continue making sub directories
    var o = { "jacob": "0", "Documents": "1", "Downloads": "2", "Music": "3", "Pictures": "4", "Videos":"5" };  //Object to assign array of sub folders to a folder
    var of = { "nugget.txt": "nugget." };  //Object to assign text to a file
    f[0] = ["nugget.txt"];
    ...
    $('body').terminal({
        ...
        cd: function(arg1) {
            ...
            if(e==1) {
                ...
                pwdv.splice(0, 1);
                var pwdvNew = pwdv.join(',').replace(/,/g, '/').split();
                y = '[[b;#44D544;]jacob@localhost/'+ pwdvNew + ':~$]';
                this.set_prompt(y);
                pwdv.unshift("jacob");
            }
            else if(e==2) {
                ...
                if(x!=0) {
                    arr[5] = 1; x = 0;
                    pwdv.splice(1);
                    y = '[[b;#44D544;]jacob@localhost/'+ pwdv + ':~$] '
                    this.set_prompt(y);
        ...
        skills: function() {
            this.echo('Skills:');
            this.echo('I am experienced in [[b;#44D544;]HTML] and [[b;#44D544;]CSS], and I have basic knowledge of [[b;#44D544;]JavaScript]');
            this.echo('I have advanced knowledge of website hosting ([[b;#44D544;]Firebase], [[b;#44D544;]Github Pages], [[b;#44D544;]Glitch], etc.)');
            this.echo('I am skilled in the [[b;#44D544;]bash command line] and [[b;#44D544;]bash scripting]');
            this.echo('I am experience in [[b;#44D544;]Python]')
            this.echo('Also, I am trying to learn [[b;#44D544;]C/C++] (Emphasis on the trying)')
            this.echo('Aside from programming, I am advanced in [[b;#44D544;]PhotoShop] and have pretty good [[b;#44D544;]Blender] skills');
        },
        portfolio: function() {
            this.echo('[[b;#ff3300;]Ninja³] <https://nuggetofwisdom.github.io/html/ninja.html>');
            this.echo('[[b;#ff3300;]Hello World (Hello World in 35 different languages)] <https://github.com/nuggetofwisdom/HelloWorld>');
            this.echo('[[b;#ff3300;]Sokoban Made In 30 Minutes] <https://nuggetofwisdom.github.io/html/sokoban.html>');
        },
        github: function() {
            this.echo('[[b;#ff3300;]Github] <https://github.com/nuggetofwisdom>');
        },
        contact: function() {
            window.open('mailto:jacobmumford06@gmail.com', '_blank');
        },
    }, {
        

    	prompt:"[[b;#44D544;]jacob@localhost:~$] ",
        greetings: 
        ...
        ' \\|________|\\|__|\\|__|\\|_______|\\|_______|\\|_______| \n\n' +
        "Hey, I'm Jacob.\n" +
        'I like to experiment with and write code, create things, and play with my Raspberry Pi 4.\n' +
        "I started programming when I was 12 (2019), and I've been obsessed ever since.\n" +
        'I also enjoy making digital creative works with programs such as Blender, PhotoShop, and others.\n' +
        'You can find more about me by typing the following commands:\n"skills", "portfolio", "github", and "contact". \n',
...
/*
    ___  ________  ________  ________  ________          _____ ______   ___  ___  _____ ______   ________ ________  ________  ________     
   |\  \|\   __  \|\   ____\|\   __  \|\   __  \        |\   _ \  _   \|\  \|\  \|\   _ \  _   \|\  _____\\   __  \|\   __  \|\   ___ \    
   \ \  \ \  \|\  \ \  \___|\ \  \|\  \ \  \|\ /_       \ \  \\\__\ \  \ \  \\\  \ \  \\\__\ \  \ \  \__/\ \  \|\  \ \  \|\  \ \  \_|\ \   
 __ \ \  \ \   __  \ \  \    \ \  \\\  \ \   __  \       \ \  \\|__| \  \ \  \\\  \ \  \\|__| \  \ \   __\\ \  \\\  \ \   _  _\ \  \ \\ \  
|\  \\_\  \ \  \ \  \ \  \____\ \  \\\  \ \  \|\  \       \ \  \    \ \  \ \  \\\  \ \  \    \ \  \ \  \_| \ \  \\\  \ \  \\  \\ \  \_\\ \ 
\ \________\ \__\ \__\ \_______\ \_______\ \_______\       \ \__\    \ \__\ \_______\ \__\    \ \__\ \__\   \ \_______\ \__\\ _\\ \_______\
 \|________|\|__|\|__|\|_______|\|_______|\|_______|        \|__|     \|__|\|_______|\|__|     \|__|\|__|    \|_______|\|__|\|__|\|_______|
 ...
 */
 ...
 /*
 If you wish to know more then head over to my [[b;#ff3300;]blog: The Roving Cosmonaut] <http://sr6033.github.io/>
 */

 /*
[[b;#ff3300;]Ninja³] <https://nuggetofwisdom.github.io/html/ninja.html>

[[b;#ff3300;]Hello World (Hello World in 35 different languages)] <https://github.com/nuggetofwisdom/HelloWorld>

[[b;#ff3300;]Sokoban Made In 30 Minutes] <https://nuggetofwisdom.github.io/html/sokoban.html>
 */